-- Rozšíření zápisu akcí o set (#32). set_cislo je volitelné a chybějící se
-- bere jako 1, aby nasazená verze aplikace, která o setech neví, dál
-- fungovala až do svého nasazení.
