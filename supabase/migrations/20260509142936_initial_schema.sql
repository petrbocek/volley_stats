...
CREATE TABLE vb_zapasy (
  ...
  datum date NOT NULL,
  cas time,
  soupet text NOT NULL,
  misto text DEFAULT 'doma',
  stav text DEFAULT 'planovany',
  sety_my int, sety_oni int,
  set1_my int, set1_oni int,
  set2_my int, set2_oni int,
  set3_my int, set3_oni int,
  set4_my int, set4_oni int,
  set5_my int, set5_oni int,
  poznamka text
);
